...
def fit_mesh(mesh_src, mesh_tgt, args, device):
    ...
    print('Rendering mesh clouds')
    render_gif_from_mesh(mesh= mesh_tgt, output_path='results/q1_mesh_GT.gif')
    render_gif_from_mesh(mesh= mesh_src, output_path='results/q1_mesh_fit.gif')
    print('Done!')
...
def fit_pointcloud(pointclouds_src, pointclouds_tgt, args):
    ...
    print('Rendering point clouds')
    render_gif_from_pc(pointclouds_tgt, output_path='results/q1_point_cloud_GT.gif')
    render_gif_from_pc(pointclouds_src, output_path='results/q1_point_cloud_fit.gif')
    print('Done!')
...
def fit_voxel(voxels_src, voxels_tgt, args):
    ...
    render_gif_from_voxel(voxel = voxels_tgt, output_path='results/q1_voxel_GT.gif')
    render_gif_from_voxel(voxel = voxels_src, output_path='results/q1_voxel_fit.gif')
    print('Done!')
